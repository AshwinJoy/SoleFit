...
<body id="page-top" class="index">
 ...
 Home</a>
                    ...
                    <li>
                        <a class="page-scroll" href="Registration/index.php"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
 Blog</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="Registration/index.php"><i class="fa fa-coffee " aria-hidden="true"></i>
 FoodSwaps</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="Registration/index.php"><i class="fa fa-spoon" aria-hidden="true"></i>
 DietPlans</a>
                    </li>
                    
                     <li>
                        <a class="page-scroll" href="Registration/index.php"><i class="fa fa-user-md " aria-hidden="true"></i>
 Dr.Fit</a>
                    </li>
                    
                     <li>
                        <a class="page-scroll" href="Registration/index.php"><i class="fa fa-hospital-o " aria-hidden="true"></i>
FitSpots</a>
                    </li>
                    
                    <li>
                        <a class="page-scroll"  href="Registration/index.php"><i class="fa fa-phone" aria-hidden="true"></i>
 Contact</a>
                    </li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <a href="Registration/index.php" class="page-scroll btn btn-xl animated swing">Get Started >></a>
            </div>
        </div>
    </header>
